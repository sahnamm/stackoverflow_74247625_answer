...
import 'package:so_q/profile_card_alignment.dart';
import 'dart:math';

import 'package:so_q/request_service.dart';
...
List<Size> cardsSize = List.filled(3, const Size(0, 0)); //  List<Size>(3);

class CardsSectionAlignment extends StatefulWidget {
  CardsSectionAlignment(BuildContext context, {Key? key}) : super(key: key) {
  ...
  @override
  State createState() => _CardsSectionState();
}
...
class _CardsSectionState extends State<CardsSectionAlignment>
      ...
      for (cardsCounter = 0; cardsCounter < 3; cardsCounter++) {
        cards.add(
          ProfileCardAlignment(
            cardsCounter,
            tempWord:
                value[cardsCounter], //directly store the api result to object
          ),
        );
      }
  ...
  Future<List<String>> requestData() async {
    return await RequestService.instance.fetchData();
  }
